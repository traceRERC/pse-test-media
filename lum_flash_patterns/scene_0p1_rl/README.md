...
| add01*n*_ 30fps_srgba. csv | Add-on transition where low state is transparent (intended for a passing area) | ![Adds a transition in the middle of the wide gap of f01n patterns](./documentation/add01n.svg) | n/a | n/a |
